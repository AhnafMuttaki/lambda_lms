...
export default function QuizCreate() {
  ...
  const handleAddQuestions = () => {
    // Navigate to add questions page (assuming quiz ID would be available after creation)
    navigate(`/quiz/1/questions/add`)
  }
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <Button type="button" variant="outline" onClick={handleAddQuestions}>
